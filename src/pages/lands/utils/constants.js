// Option export constants - match Add Land form
export const LAND_SALE_STATUS_OPTIONS = ['TOKEN RECEIVED', 'AVAILABLE FOR SALE', 'AGREEMENT Made', 'NOT AVAILABLE', 'SOLD'];
export const MORTGAGE_STATUS_OPTIONS = ['AVAILABLE FOR MORTGAGE', 'CURRENTLY MORTGAGED', 'NOT AVAILABLE'];
export const URGENCY_OPTIONS = ['urgent sale', 'premium listing'];
export const OWNERSHIP_TYPE_OPTIONS = ['Ancestral', 'Purchased'];
export const LOCALITY_OPTIONS = ['Local', 'Non-local'];
export const OWNERSHIP_STATUS_OPTIONS = ['Own', 'Joint'];
export const AGE_OPTIONS = ['Upto 30', '30-50', '50+'];
...
export const LAND_SALE_STATUS = LAND_SALE_STATUS_OPTIONS;
export const URGENCY_LISTING = URGENCY_OPTIONS;
