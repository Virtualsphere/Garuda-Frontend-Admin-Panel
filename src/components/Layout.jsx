...
export default function Layout() {
  ...
  return (
    <div className="flex w-full h-screen">
      ...
      <div className={`
        fixed lg:static
        w-72 h-full bg-white text-gray-800 border-r border-gray-200 shadow-sm flex flex-col p-4 space-y-6
      ...
      `}>
        ...
        <div>
          ...
          {/* USER */}
          <div className="flex items-center space-x-3 p-2 bg-gray-50 border border-gray-100 rounded-xl">
              ...
              <div className="space-y-1">
                ...
                {section.items.map((item) => (
                  <button
                    ...
                    className={`
                      w-full flex items-center space-x-3 py-2 px-2 rounded-lg transition-all text-left font-medium
                      ${active === item.name
        ...
        <div className="pt-4 border-t border-gray-200">
          <button
            onClick={logoutUser}
            className="w-full flex items-center space-x-3 py-2 px-2 rounded-lg hover:bg-red-50 text-red-600 hover:text-red-700 transition-colors font-medium"
          >
            <LogOut size={18} />
